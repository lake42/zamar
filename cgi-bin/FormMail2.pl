...
BEGIN
{
  ...
  $allow_empty_ref   = 1;
  $max_recipients    = 5;
my $filename ='../stat2/feedbacks.txt';
  $mailprog          = '/usr/lib/sendmail -oi -t';
  $postmaster        = 'rscontinuum@zamarentertainment.com';
  @referers          = qw(zamarentertainment.com id403.van.ca.siteprotect.com);
  @allow_mail_to     = qw(rscontinuum@zamarentertainment.com zamarentertainment.com);
  @recipients        = ();
  %recipient_alias   = ();
